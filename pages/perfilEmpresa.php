...
$idEmpresa = $_SESSION['dadosUsuarioLogado'][11];

$id_usuario_logado = $_SESSION['dadosUsuarioLogado'][11];

include('../controller/select/selectDadosUsuarioLogadado.php');
$dadosUsuarioLogado = selectDadosUsuario();

include('../controller/select/selectPostagensEmpresa.php');
$postagensPerfil = selectPostagemUsuarioEmpresa($idEmpresa);

include('../controller/select/selectPostagens.php');

$todasPostagens = selectTodasPostagensRelacEmpresa($idEmpresa);
                   ...
                   <ul class="list-group bg-light ">
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">
                                    <h6>Postagens relacionadas a voc</h6>
                                </div>
                                <div class="border-0">
                ...
                <table class="table mt-5">
                    ...
                    <tbody>
                        ...
                        foreach ($postagensPerfil as $postagem) {
                            ...
                            $respondidas_nao_respondidas = selectRespondidasNaoRespondidasEmpresa($id_usuario_logado, $id_postagem); 
                        ?>
                            <tr>
                                <td scope="row">
                                <?php
